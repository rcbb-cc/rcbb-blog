...
![config.ts配置](https://rcbb-blog.oss-cn-guangzhou.aliyuncs.com/2022/07/20220728115018-daebe0.png?x-oss-process=style/yuantu_shuiyin)
...
![New OAuth App](https://rcbb-blog.oss-cn-guangzhou.aliyuncs.com/2022/07/20220728110650-084683.png?x-oss-process=style/yuantu_shuiyin)

将 https://rcbb.cc 更换为自己的域名即可。

然后就可以得到 clientId、clientSecret 了。

![clientId、clientSecret](https://rcbb-blog.oss-cn-guangzhou.aliyuncs.com/2022/07/20220728114731-42a2f2.png?x-oss-process=style/yuantu_shuiyin)

将网站重新部署后，测试评论~

![测试评论](https://rcbb-blog.oss-cn-guangzhou.aliyuncs.com/2022/07/20220728115529-ba26ae.png?x-oss-process=style/yuantu_shuiyin)

有用户评论后，会在配置的 github 项目的 issues 中。

![查看评论](https://rcbb-blog.oss-cn-guangzhou.aliyuncs.com/2022/07/20220728114830-c462dc.png?x-oss-process=style/yuantu_shuiyin)
